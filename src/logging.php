...
function log_content_found($content)
{
	$log_entry = "Content Found (".date('l jS \of F Y h:i:s A')."): ".$content.PHP_EOL.PHP_EOL;
	echo $log_entry;
	file_put_contents(LOG_FILE_PATH.".found", $log_entry, FILE_APPEND);
}
